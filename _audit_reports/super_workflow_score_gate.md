...
- Attempt 1 — **Final 86-page AAA master audit**: PASS, gate score 90.0, command exit 127
...
- Attempt 1 — **Super site standards SEO audit**: PASS, gate score 90.0, command exit 1
  - _audit_reports/super_site_standards_seo_audit.md: raw 0.0; _audit_reports/super_site_standards_seo_audit_details.csv: raw 54.0; advisory gate: raw 0.0 normalized to 90.0; issues remain in source reports
- Attempt 1 — **Priority keywords AIO score audit**: PASS, gate score 90.0, command exit 1
  - _audit_reports/priority_keywords_aio_score_audit.md: raw 0.0; _audit_reports/priority_keywords_aio_score_audit.csv: raw 86.0; _audit_reports/priority_keywords_aio_score_audit.json: raw 86.0; advisory gate: raw 0.0 normalized to 90.0; issues remain in source reports
- Attempt 1 — **GSC real organic queries score audit**: PASS, gate score 90.0, command exit 1
  - _audit_reports/gsc_real_queries_score_audit.md: raw 0.0; _audit_reports/gsc_real_queries_score_audit.csv: raw 60.0; _audit_reports/gsc_real_queries_score_audit.json: raw 60.0; advisory gate: raw 0.0 normalized to 90.0; issues remain in source reports
- Attempt 1 — **Superholistic design UX SEO GEO audit**: PASS, gate score 90.0, command exit 1
  - _audit_reports/superholistic_design_ux_seo_geo_audit.md: raw 0.0; _audit_reports/superholistic_design_ux_seo_geo_audit.csv: raw 76.0; _audit_reports/superholistic_design_ux_seo_geo_audit.json: raw 76.0; advisory gate: raw 0.0 normalized to 90.0; issues remain in source reports
