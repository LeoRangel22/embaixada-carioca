...
- cafe-da-manha.html: excesso de blocos <style> inline (12). Impacta manutenção e performance percebida.
- cafe-da-manha.html: possível FAQ/schema duplicado.
- almoco.html: excesso de blocos <style> inline (13). Impacta manutenção e performance percebida.
- almoco.html: possível FAQ/schema duplicado.
- entardecer.html: excesso de blocos <style> inline (13). Impacta manutenção e performance percebida.
