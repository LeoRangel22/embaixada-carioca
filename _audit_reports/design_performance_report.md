...
- index.html: excesso de blocos <style> inline (23). Impacta manutenção e performance percebida.
- cafe-da-manha.html: excesso de blocos <style> inline (17). Impacta manutenção e performance percebida.
- almoco.html: excesso de blocos <style> inline (18). Impacta manutenção e performance percebida.
- entardecer.html: excesso de blocos <style> inline (18). Impacta manutenção e performance percebida.
- eventos.html: excesso de blocos <style> inline (17). Impacta manutenção e performance percebida.
- cardapio.html: excesso de blocos <style> inline (18). Impacta manutenção e performance percebida.
...
- en/almoco.html: excesso de blocos <style> inline (17). Impacta manutenção e performance percebida.
- en/almoco.html: possível FAQ/schema duplicado.
- en/entardecer.html: excesso de blocos <style> inline (17). Impacta manutenção e performance percebida.
...
- es/almoco.html: excesso de blocos <style> inline (16). Impacta manutenção e performance percebida.
- es/almoco.html: possível FAQ/schema duplicado.
- es/entardecer.html: excesso de blocos <style> inline (17). Impacta manutenção e performance percebida.
