...
- Attempt 1 — **Superholistic design UX SEO GEO audit**: PASS, gate score 90.0, command exit 1
  - _audit_reports/superholistic_design_ux_seo_geo_audit.md: raw 0.0; _audit_reports/superholistic_design_ux_seo_geo_audit.csv: raw 94.0; _audit_reports/superholistic_design_ux_seo_geo_audit.json: raw 94.0; advisory gate: raw 0.0 normalized to 90.0; issues remain in source reports
