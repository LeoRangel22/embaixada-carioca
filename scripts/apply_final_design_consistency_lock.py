...
.btn,a.btn,button.btn,.hero-ctas .btn,.ctas .btn{min-height:60px!important;height:60px!important;padding:0 36px!important;border-radius:999px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:0!important;font-family:"JetBrains Mono",ui-monospace,monospace!important;font-size:14px!important;line-height:1!important;font-weight:900!important;letter-spacing:.13em!important;text-transform:uppercase!important;text-align:center!important;text-decoration:none!important;white-space:nowrap!important;border:1px solid var(--amarelo,#f59b1e)!important;background:var(--amarelo,#f59b1e)!important;color:#fff!important;box-shadow:0 9px 0 rgba(0,64,90,.20),0 16px 30px rgba(0,32,46,.18)!important;overflow:hidden!important;}
...
.btn-secondary,a.btn-secondary,.hero-ctas .btn-secondary,.hero-ctas a.btn-secondary,.ctas .btn-secondary,.ctas a.btn-secondary,.hero-ctas a:not(.btn):not(.nav-wa-btn),.ctas a:not(.btn):not(.nav-wa-btn){min-height:60px!important;height:60px!important;padding:0 36px!important;border-radius:999px!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;gap:0!important;font-family:"JetBrains Mono",ui-monospace,monospace!important;font-size:14px!important;line-height:1!important;font-weight:900!important;letter-spacing:.13em!important;text-transform:uppercase!important;text-align:center!important;text-decoration:none!important;white-space:nowrap!important;color:var(--areia-pale,#f6efde)!important;border:1px solid rgba(246,239,222,.82)!important;background:rgba(0,32,46,.18)!important;box-shadow:inset 0 0 0 1px rgba(246,239,222,.08),0 10px 26px rgba(0,32,46,.18)!important;backdrop-filter:blur(6px)!important;}
nav.top .btn,nav.top a.btn[href*="tagme"]{min-height:60px!important;height:60px!important;width:188px!important;min-width:188px!important;padding:0!important;letter-spacing:.16em!important;}
...
def audit(p):
    ...
    checks = {
        ...
        'no_pin_in_nav_or_buttons':'drawer-icon' not in text,
...
def write_reports():
    ...
    lines = ['# Final Design Consistency Lock','','## Objetivo','Padronizar linha laranja, botões, frames/pílulas acima dos botões e remover setas/pins residuais.','','## Veredito',f'- Páginas auditadas: {len(DETAILS)}',f'- PASS: {len(DETAILS)-len(warn)}',f'- WARN: {len(warn)}',f"- Status geral: {'PASS' if not warn else 'WARN'}",'','## Contadores']
